...
export default function Home() {
  return (
    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen bg-[#06101E] p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-euclid-circular-b)]">
      
      {/* Dotted flower art */}
      <img className="absolute bottom-[-9rem] left-[-7rem]" src="/pointillism/dot-grey-flower.svg" alt="pointilism flower" width="448"/>
      <img className="absolute top-[19rem] right-[-8rem]" src="/pointillism/dot-green-flower.svg" alt="pointilism flower" width="448"/>

      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        

        <div className="grid grid-cols-[55%_45%] gap-4">
        <div className="w-100 grid grid-cols-[10%_90%] gap-2">
          {/* Positioning the ">" */}
          ...
          <div className="flex flex-col gap-y-4">
            ...
            <h1 className="text-[#FFFFFF] text-7xl font-medium">HACK THE VALLEY X</h1>
        ...
        <div className="relative w-[700px]">
          <img className="" src="/landing-page/date-card-2.svg" alt="Event Card" width="573"/>
          <img className="absolute top-[-11rem] left-[-3rem]" src="/landing-page/event-card-2.svg" alt="Event Card" width="662"/>
